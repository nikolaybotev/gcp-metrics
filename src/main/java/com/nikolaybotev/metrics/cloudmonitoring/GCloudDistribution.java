...
public class GCloudDistribution implements Distribution {
    ...
    private final SerializableLazy<HistogramBucketAggregator> aggregator;

    public GCloudDistribution(GCloudMetrics metrics, String name, String unit, Buckets buckets, SerializableLazy<HistogramBucketAggregator> aggregator) {
